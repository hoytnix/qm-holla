                  ...
                  <div className="mt-5 flex flex-wrap gap-2 pt-4 border-t border-white/5">
                    {msg.suggested_actions.map((action, aIdx) => (
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/20 text-xs text-branding/60 hover:text-branding transition-all cursor-pointer flex items-center gap-2"
                      >
